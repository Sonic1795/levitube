		...
		<div id="site-bottom">
			...
			<div class="inner-wrap clear">
				...
				<div class="site-info">
					...
					<?php
						$theme_uri = 'https://www.happythemes.com/wordpress-themes/fastvideo/';
						$author_uri = 'https://www.happythemes.com/';
					?>

					&copy; <?php echo date("o"); ?> - <a href="<?php echo $theme_uri; ?>">FastVideo Theme</a> by <a href="<?php echo $author_uri; ?>" target="_blank">HappyThemes</a>
