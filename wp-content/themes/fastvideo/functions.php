...
function fastvideo_scripts() {
    ...
    wp_enqueue_script('jquery', get_stylesheet_directory_uri() . '/assets/js/jquery.js', array(), '', true );
     ...
     wp_enqueue_script( 'custom', get_stylesheet_directory_uri() . '/assets/js/jquery.custom.js', array(), '20171101', true );

    // Enqueues CSS styles
    wp_enqueue_style( 'fastvideo-style', get_stylesheet_uri(), array(), '20170515' );     
    ...
    if ( get_theme_mod( 'site-layout', 'choice-1' ) == 'choice-1' ) {
    	wp_enqueue_style( 'responsive-style',   get_template_directory_uri() . '/responsive.css', array(), '20170509' ); 
	}
